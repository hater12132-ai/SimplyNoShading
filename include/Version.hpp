...
inline constexpr std::string_view Description = "Performance (120Hz FPS unlock) + Fast Containers for chests/shulkers.";
inline constexpr std::string_view Version = "1.0.1";
